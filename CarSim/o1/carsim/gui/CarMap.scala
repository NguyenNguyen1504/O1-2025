...
class CarMap(tileSource: TileSource, center: Pos, zoomLevel: Int) extends MapPanel(tileSource):
  ...
  def newRouteHighlight(route: IndexedSeq[Segment]): Unit =
    ...
    def dropEvenlyTillMax(elements: IndexedSeq[Segment]) =
      val dropRatio = (elements.size ddiv MaxNumberOfMarkers) atLeast 1.0
...
private object CarMap:
  ...
  object Marker:
    ...
    import o1.gui.swingops.Null
    class Destination(location: Coordinate) extends Marker(/*layer=*/ Null, /*name=*/ Null, location, /*radius=*/ 8, MapMarker.STYLE.FIXED,
                                                           Style(Color.black, Color(100, 100, 255), /*stroke=*/ Null, /*font=*/ Null))
    class Route(location: Coordinate)       extends Marker(/*layer=*/ Null, /*name=*/ Null, location, /*radius=*/ 1, MapMarker.STYLE.FIXED,
                                                           Style(Color.blue, Color.blue, /*stroke=*/ Null, /*font=*/ Null))
  end Marker
